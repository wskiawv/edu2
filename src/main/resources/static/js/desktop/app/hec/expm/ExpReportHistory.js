Ext.define('desktop.app.hec.expm.ExpReportHistory',{
	extend:'desktop.app.comm.ShowGrid',
	alias:['widget.ExpReportHistory'],
	
	
	moduleName:"expm",//请求模块名称    
	controllersName:"ExpReportHistorys",//请求控制器名称
	 
    getStoreModel : function(){
		return 'desktop.app.hec.expm.model.ExpReportHistory';
	},
...
Ext.define('desktop.app.hec.expm.model.ExpReportHistory',{
