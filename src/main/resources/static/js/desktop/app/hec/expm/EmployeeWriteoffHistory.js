Ext.define('desktop.app.hec.expm.EmployeeWriteoffHistory',{
	extend:'desktop.app.comm.ShowGrid',
	alias:['widget.EmployeeWriteoffHistory'],
	
	
	moduleName:"expm",//请求模块名称    
	controllersName:"EmployeeWriteoffHistories",//请求控制器名称
	 
    getStoreModel : function(){
		return 'desktop.app.hec.expm.model.EmployeeWriteoffHistory';
	},
...
Ext.define('desktop.app.hec.expm.model.EmployeeWriteoffHistory',{
