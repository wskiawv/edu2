Ext.define('desktop.app.hec.expm.DocumentWriteoffHistory',{
	extend:'desktop.app.comm.ShowGrid',
	alias:['widget.DocumentWriteoffHistory'],
	
	
	moduleName:"expm",//请求模块名称    
	controllersName:"DocumentWriteoffHistories",//请求控制器名称
	 
    getStoreModel : function(){
		return 'desktop.app.hec.expm.model.DocumentWriteoffHistory';
	},
...
Ext.define('desktop.app.hec.expm.model.DocumentWriteoffHistory',{
