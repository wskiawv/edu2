Ext.define('desktop.app.hec.csh.CshPaymentRequistionHistory',{
	extend:'desktop.app.comm.ShowGrid',
	alias:['widget.CshPaymentRequistionHistory'],
	
	
	moduleName:"csh",//请求模块名称    
	controllersName:"CshPaymentRequistionHistorys",//请求控制器名称
	 
    getStoreModel : function(){
		return 'desktop.app.hec.csh.model.CshPaymentRequistionHistory';
	},
...
Ext.define('desktop.app.hec.csh.model.CshPaymentRequistionHistory',{
