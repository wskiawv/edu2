Ext.define('desktop.app.hec.cont.ConContractHeadersReceiptDetails',{
	extend:'desktop.app.comm.ShowGrid',
	alias:['widget.ConContractHeadersReceiptDetails'],
	
	
	moduleName:"cont",//请求模块名称    
	controllersName:"ConContractHeadersReceiptDetailes",//请求控制器名称
	 
    getStoreModel : function(){
		return 'desktop.app.hec.cont.model.ConContractHeadersReceiptDetails';
	},
...
Ext.define('desktop.app.hec.cont.model.ConContractHeadersReceiptDetails',{
